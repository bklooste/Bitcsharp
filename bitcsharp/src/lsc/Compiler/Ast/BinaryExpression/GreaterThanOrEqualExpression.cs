...
{
    public class AstGreaterThanOrEqualExpression : AstBinaryExpression
    {
        public AstGreaterThanOrEqualExpression(
        ...
        public AstGreaterThanOrEqualExpression(IParser parser)
            : base(parser) { }

        public AstGreaterThanOrEqualExpression(IParser parser, bool useLookAhead) : base(parser, useLookAhead) { }

        public override string ToString()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("--AstGreaterThanOrEqualExpression--{0}{0}");
