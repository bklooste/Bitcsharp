...
{
    public class AstGreaterThanExpression : AstBinaryExpression
    {
        ...
        public AstGreaterThanExpression(IParser parser)
            : base(parser) { }
        public AstGreaterThanExpression(IParser parser, bool useLookAhead) : base(parser, useLookAhead) { }

        public override string ToString()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("--AstGreaterThanExpression--{0}{0}");
