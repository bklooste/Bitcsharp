...
{
    public class AstSubtractionExpression : AstBinaryExpression
    {
        ...
        public AstSubtractionExpression(IParser parser)
            : base(parser) { }
        public AstSubtractionExpression(IParser parser, bool useLookAhead) : base(parser, useLookAhead) { }

        public override string ToString()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("--AstSubtractionExpression--{0}{0}");

            sb.Append("Src: {1}{0}");
            sb.Append("Ln: {2}{0}");
            sb.Append("Col: {3}{0}{0}");

            sb.Append("Operator Type: Subtraction -");
