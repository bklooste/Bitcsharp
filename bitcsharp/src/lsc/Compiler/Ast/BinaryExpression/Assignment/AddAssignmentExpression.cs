...
{
    public class AstAddAssignmentExpression : AstAssignmentExpression
    {
        public AstAddAssignmentExpression(
        ...
        public AstAddAssignmentExpression(IParser parser)
            : base(parser) { }

        public AstAddAssignmentExpression(IParser parser, bool useLookAhead) : base(parser, useLookAhead) { }

        public override string ToString()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("--AstAddAssignmentExpression--{0}{0}");
        ...
        //    set
        //    {
        //        throw new LLVMSharpException("You cannot assign AssociatedType");
        //    }
        //}
