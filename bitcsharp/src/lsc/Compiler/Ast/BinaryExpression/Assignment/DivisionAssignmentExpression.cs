...
{
    public class AstDivisionAssignmentExpression : AstAssignmentExpression
    {
        ...
        public AstDivisionAssignmentExpression(IParser parser)
            : base(parser) { }

        public AstDivisionAssignmentExpression(IParser parser, bool useLookAhead) : base(parser, useLookAhead) { }

        public override string ToString()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("--AstDivisionAssignmentExpression--{0}{0}");
