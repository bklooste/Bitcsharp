...
{
    public class AstEqualityExpression : AstBinaryExpression
    {
        ...
        public AstEqualityExpression(IParser parser)
            : base(parser) { }

        public AstEqualityExpression(IParser parser, bool useLookAhead) : base(parser, useLookAhead) { }

        public override string ToString()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("--AstEqualityExpression--{0}{0}");
